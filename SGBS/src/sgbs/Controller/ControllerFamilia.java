...
//    
//    public int gerador(){
//        FamiliaDao fmDao=new FamiliaDao();
//        int num=fmDao.lastId()+1;
//        return num;
//    }
//    
...
//       if(vd.valTxt(nome, 3, 50)&&vd.valTxt(nome, 3, 50)&&vd.valTxt(descricao, 5, 45)){
//            
//            fm=new Familia(codigo, nome,descricao);
//          //  ManageFuncio mF=new ManageFuncionario();
//            mF.salvar(fm);
//            status=true;
//     
//       }
