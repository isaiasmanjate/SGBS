...
public class Familia {
    ...
    private JLabel familiaLabel,descricaoLabel,gravarBtnTxt,cancelarBtnTxt,terminarBtnTxt, favicon, produto;
    private sgbs.View.controles.textfield_suggestion.TextFieldSuggestion familiaTxt,descricaoTxt;
    ...
    private void inicializarComponentes(){
        janela = new JFrame("Criacao de Familia");
        ...
        familiaTxt = new sgbs.View.controles.textfield_suggestion.TextFieldSuggestion();
    ...
    private void configurar_pPrincipal() {
        ...
        familiaLabel.setFont(new java.awt.Font("Roboto Light", 1, 14));
        familiaLabel.setText("Familia");
        gbc.gridx = 1;
        gbc.gridy = 3; pPrincipal.add(familiaLabel , gbc);
        
        gbc.gridx = 2;
        familiaTxt.setPreferredSize(new Dimension(190, 35));
        gbc.gridy = 3; pPrincipal.add(familiaTxt , gbc);
        
        descricaoLabel.setFont(new java.awt.Font("Roboto Light", 1, 14));
        descricaoLabel.setText("Descricao");
        gbc.gridx = 1;
        gbc.gridy = 4; pPrincipal.add(descricaoLabel , gbc);
        
        gbc.gridx = 2;
        gbc.gridwidth = 2;
        descricaoTxt.setPreferredSize(new Dimension(390, 35));
        gbc.gridy = 4; pPrincipal.add(descricaoTxt , gbc);
        
        
        gbc.gridx = 3;
        gbc.anchor = GridBagConstraints.LAST_LINE_END;
        gbc.gridy = 7; pPrincipal.add(pBotoGravar , gbc);
        gbc.gridx = 4;
        gbc.gridy = 7; pPrincipal.add(pBotoCancelar , gbc);
    }
