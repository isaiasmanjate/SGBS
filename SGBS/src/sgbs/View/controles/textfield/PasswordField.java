package sgbs.View.controles.textfield;
...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/sgbs/View/controles/textfield/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/sgbs/View/controles/textfield/eye_hide.png")).getImage();
