...
public class Stock  {
    ...
    private sgbs.View.controles.combo_suggestion.ComboBoxSuggestion c_Fornecedor;
    ...
    private void inicialializarComponentes() {
        ...
        c_Fornecedor = new sgbs.View.controles.combo_suggestion.ComboBoxSuggestion();
       ...
       // b_confirmar.setBorder(null);
        b_confirmar.setBorder(new RoundedBorder(20));
...
//        constraints.weighty=1;
    ...
    private void personalizarComponent() {
        ...
        c_Fornecedor.setPreferredSize(new Dimension(150, 30));
        //contacto
        ...
        //Procurar
        b_procurar.setPreferredSize(new Dimension(30, 25));
        b_procurar.setBackground(Color.LIGHT_GRAY);
